  ...
  return (
    <div className="fixed bottom-5 right-4 z-50 flex flex-col items-end gap-2">
      ...
      {open && (
        <div className="flex flex-col gap-2 animate-fadein">
          <a
            ...
            className="flex items-center gap-2.5 bg-line-green text-white font-bold text-sm px-5 py-3 rounded-full shadow-xl hover:opacity-90 transition-opacity whitespace-nowrap"
          >
          ...
          <a
            href={`tel:${TEL}`}
            className="flex items-center gap-2.5 bg-navy text-white font-bold text-sm px-5 py-3 rounded-full shadow-xl hover:opacity-90 transition-opacity whitespace-nowrap"
          >
      ...
      <button
        ...
        className="w-14 h-14 rounded-full bg-line-green text-white shadow-2xl flex items-center justify-center hover:opacity-90 active:scale-95 transition-all"
